...
describe('controller/timePunchController.js', function() {
	...
	beforeEach(function () {
        ...
        controller = proxyquire(path.join(process.cwd(), 'app/controller', 'timePunchController'), {
            '../processor/timePunchProcessor': {
